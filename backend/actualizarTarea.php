<?php
	...
	if($_SERVER['REQUEST_METHOD'] == 'POST'){
		...
		if(isset($_POST['actualizar']))
		{
			...
			echo modificarTarea($idTarea, $nombre, $descripcion, $codigo, $entidad);	
		...
		<div id = "cajaFormulario">
		  ...
		  <div class="input-group mb-3">
				  <div class="input-group-prepend">
				    <label class="input-group-text" for="inputGroupSelect01">Entidad Auditada</label>
				  </div>


			  		<select name="entidadselect" class="custom-select" id="inputGroupSelect01">
			  			 <?php
			  				$array = devolverAuditada($entidadUser);
